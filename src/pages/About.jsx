                            ...
                            <main className="flex-grow">
                                ...
                                <div className="px-10 py-12">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                                        <div>
                                            <h2 className="text-primary dark:text-primary text-3xl font-bold leading-tight pb-4 font-display">Our Mission</h2>
                                            <p className="text-[#181411] dark:text-gray-300 text-lg font-normal leading-relaxed">To create exquisite jewelry that celebrates life's most cherished moments. We are dedicated to providing our clients with pieces of unparalleled beauty and quality, designed to be treasured for a lifetime and beyond.</p>
                                        </div>
                                        <div className="text-right">
                                            <h2 className="text-primary dark:text-primary text-3xl font-bold leading-tight pb-4 font-display">Our Values</h2>
                                            <p className="text-[#181411] dark:text-gray-300 text-lg font-normal leading-relaxed">Craftsmanship, integrity, and customer devotion are the pillars of our brand. We believe in the beauty of detail, the importance of ethical sourcing, and the creation of a personal, memorable experience for every client who walks through our doors.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="px-10 py-12 text-center">
                                    <blockquote className="text-[#181411] dark:text-white text-3xl italic font-light leading-snug max-w-4xl mx-auto border-l-4 border-primary pl-6 font-display">"Jewelry is more than adornment. It's a piece of art, a fragment of history, a promise for the future."</blockquote>
                                    <p className="mt-4 text-primary dark:text-primary text-lg font-medium">- The Founders</p>
                                </div>
                            </main>
