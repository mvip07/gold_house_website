            ...
            <div class="relative flex min-h-screen w-full flex-col overflow-x-hidden">
                <header class="absolute top-0 left-0 right-0 z-50 px-4 md:px-10 lg:px-20 py-6">
                    <div class="flex items-center justify-between mx-auto">
                        <Link class="flex items-center gap-3" to="#">
                        ...
                        <nav class="hidden lg:flex items-center gap-10 text-lg">
                            <Link class="text-white hover:text-accent transition-colors" to="/about">
                                About
                            </Link>
                            <Link class="text-white hover:text-accent transition-colors" to="/collection">
                                Products
                            </Link>
                            <Link class="text-white hover:text-accent transition-colors" to="/story">
                                Our Story
                            </Link>
                            <Link class="text-white hover:text-accent transition-colors" to="/contact">
                                Contact
                            </Link>
                        </nav>
                        <div class="flex items-center gap-4">
                            <div class="hidden sm:flex items-center gap-2 text-white">
                                <Link class="px-2 py-1 text-sm font-medium hover:text-accent transition-colors" to="#">
                                    EN
                                </Link>
                                <span class="text-gray-400">/</span>
                                <Link class="px-2 py-1 text-sm font-medium hover:text-accent transition-colors text-gray-400" to="#">
                                    UZ
                                </Link>
                                <span class="text-gray-400">/</span>
                                <Link class="px-2 py-1 text-sm font-medium hover:text-accent transition-colors text-gray-400" to="#">
                ...
                <main class="flex-grow">
                    <section class="relative h-screen w-full">
                        ...
                        <div class="relative z-20 flex flex-col items-center justify-center h-full text-center text-white px-4">
                            ...
                            <Link class="px-8 py-3 bg-accent text-white font-bold text-lg rounded-full hover:bg-opacity-80 transition-all duration-300" to="#products">
                    ...
                    <section class="py-20 lg:py-32 bg-background-light dark:bg-background-dark" id="about">
                        <div class="container mx-auto px-4 lg:px-20 grid lg:grid-cols-2 gap-12 items-center">
                            <div class="text-center lg:text-left">
                                ...
                                <p class="font-body text-lg lg:text-xl text-gray-700 dark:text-gray-300 mb-8">For over three decades, Gold House has been synonymous with exceptional quality and artistry. We are Link family-owned business dedicated to preserving the ancient craft of goldsmithing while embracing contemporary design.</p>
                                <Link class="inline-block px-8 py-3 border border-accent text-accent font-bold text-lg rounded-full hover:bg-accent hover:text-white transition-all duration-300" to="#">
                                    Learn More About Us
                                </Link>
                            </div>
                            <div>
                    ...
                    <section class="py-20 lg:py-32 bg-gray-50 dark:bg-gray-900" id="products">
                        <div class="container mx-auto px-4 lg:px-20">
                            <div class="text-center mb-16">
                                ...
                                <p class="font-body text-lg lg:text-xl text-gray-700 dark:text-gray-300 mt-4 max-w-2xl mx-auto">Each piece is Link testament to our commitment to excellence, designed to be cherished for generations.</p>
                            </div>
                                ...
                                <div class="relative flex flex-col gap-12">
                                    <div class="md:flex items-center md:gap-8 w-full">
                                        <div class="md:w-1/2 md:text-right md:pr-8">
                                            ...
                                            <p class="font-body text-lg text-gray-700 dark:text-gray-300">Our founder opens Link small workshop with Link vision to create extraordinary jewelry.</p>
                                        </div>
                    ...
                    <section class="py-20 lg:py-32 bg-cover bg-center" id="contact" style={{backgroundImage: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(\"image-f77977a414964648937000e3952f1e68\")"}}>
                        <div class="container mx-auto px-4 lg:px-20 text-center">
                            ...
                            <p class="font-body text-xl text-gray-300 mt-4 max-w-2xl mx-auto">Contact us for Link private consultation or to discuss Link bespoke commission.</p>
                            <Link class="mt-8 inline-block px-10 py-4 bg-accent text-white font-bold text-lg rounded-full hover:bg-opacity-80 transition-all duration-300" to="#">
                                Get in Touch
                            </Link>
                        </div>
                    </section>
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div>
                                ...
                                <ul class="font-body space-y-2 text-gray-400">
                                    <li>
                                        <Link class="hover:text-white" to="#about">
                                            About Us
                                        </Link>
                                    </li>
                                    <li>
                                        <Link class="hover:text-white" to="#products">
                                            Collections
                                        </Link>
                                    </li>
                                    <li>
                                        <Link class="hover:text-white" to="#contact">
                                            Contact
                                        </Link>
                                    </li>
                                </ul>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    <Link class="text-gray-400 hover:text-white" to="#">
