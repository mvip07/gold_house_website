                        ...
                        <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0edea] dark:border-b-[#2a2622] px-4 sm:px-6 md:px-10 py-3">
                                ...
                                <div class="hidden md:flex flex-1 justify-end items-center gap-8">
                                    <div class="flex items-center gap-9">
                                        <Link class="text-[#181411] dark:text-gray-300 text-sm font-medium leading-normal font-sans" to="/">
                                            Home
                                        </Link>
                                        <Link class="text-[#181411] dark:text-gray-300 text-sm font-medium leading-normal font-sans" to="/about">
                                            About
                                        </Link>
                                        <Link class="text-primary dark:text-primary text-sm font-medium leading-normal font-sans" to="/story">
                                            Our Journey
                                        </Link>
                                        <Link class="text-[#181411] dark:text-gray-300 text-sm font-medium leading-normal font-sans" to="/contact">
                                            Contact
                                        </Link>
                                    </div>
                                    <div class="flex items-center gap-4 text-sm font-medium text-[#181411] dark:text-gray-300">
                                        <Link class="font-bold text-primary dark:text-primary" to="#">
                                            EN
                                        </Link>
                                        <span class="text-gray-300 dark:text-gray-600">/</span>
                                        <Link class="hover:text-primary" to="#">
                                            UZ
                                        </Link>
                                        <span class="text-gray-300 dark:text-gray-600">/</span>
                                        <Link class="hover:text-primary" to="#">
                                ...
                                <div class="py-12 md:py-20">
                                    <div class="flex min-h-[360px] md:min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat rounded-xl items-center justify-center p-4" data-alt="Abstract gold texture background" style={{backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.5) 100%), url(\"https://lh3.googleusercontent.com/aida-public/AB6AXuBlqe6AXfKb2LRCMTSInofgPy0w0hV5sbzWiQxaSIfcKMAcqjgA6W7IRrYOwiabs-SjkUwaSBHNN8lLZWAeX4wZ0fvt1JSSriIP21QXG7Bm3bRaoKS0uHzC9jbYaUwQRW5G0PIf6ETA8m99oWVLzgR8YVKkjf3Xhg14vpd2a2xwDTrQ6JEI1Vs_pKSSLtyw9qLzmxqPPpvA_atMwVojfyuJvJXRgHNm1KRcBDOef7L1lsuyeJd5nQIdJDitSjVZdHRcM1qT4blDyA\")"}}>
                                        <div class="flex flex-col gap-4 text-center">
                                            ...
                                            <h2 class="text-white text-base md:text-lg font-normal leading-normal max-w-2xl mx-auto font-sans">Discover the story of Gold House, from humble beginnings to Link symbol of elegance and quality.</h2>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="relative flex items-center group">
                                            <div class="hidden md:block w-1/2 pr-8">
                                                <div class="bg-white dark:bg-background-dark p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400 mt-2 font-sans">The founding of Gold House with Link vision to create timeless jewelry that embodies elegance and craftsmanship.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full md:w-1/2 md:pl-8">
                                                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    <img class="w-full h-64 object-cover" alt="Founder's vintage workshop" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBilVUQ9s7u_9tTZ6Vz4J__VSGke0vaQizjXWKNDHksRKhfztWmg-qAmeisE8L2rpc26NNOKsHRHK83-zy6EQzDA_d8WTnVnmjn_vFOJ8a6-ImxFKIaEOMpdohrclPXqKciS3MChPFAAjhGf3UrS3R3UoS82KG4iCYdXEKgFIh5sN8l9oyaisNTU2YZ1MVO15TXH8zzMbIc6zwrQvArpPh5KomHHZ-HFVTTOihiNE3CYqed84w1zT80kilYyltgl7k324P-EOh7wQ" />
                                                    <div class="md:hidden bg-white dark:bg-background-dark p-4">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mt-1 font-sans text-sm">The founding of Gold House with Link vision to create timeless jewelry that embodies elegance and craftsmanship.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="relative flex items-center flex-row-reverse group">
                                            <div class="hidden md:block w-1/2 pl-8">
                                                <div class="bg-white dark:bg-background-dark p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400 mt-2 font-sans">The grand opening of our first flagship store, Link landmark moment that brought our creations to the public.</p>
                                                </div>
                                            </div>
                                            <div class="absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-primary ring-8 ring-background-light dark:ring-background-dark flex items-center justify-center">
                                            ...
                                            <div class="w-full md:w-1/2 md:pr-8">
                                                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    <img class="w-full h-64 object-cover" alt="First flagship store exterior" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDH9M2k_Ect__TxX61y3WKP3UzGSfu9xjdMUvRyZeozUDXKg1BNtjt_f6a0EtcY-pbuRW6iUoLE-Cnabx27EupEuRkyePVnzEKYENr7KWT6pZTAlSXpGtoPkxA3ZGDKPFb-BGobpGe872y_JcXf9WIOROq-mOum_YWqW_Y-CQciHjUsZwIvEogVKvkFTH4va2modnQ-yz_KsP_x_0sijoiEErPPSrmVnB1EfbIO1j4iKbqVf3lU712L95g9AJYEa8Z3PkUjIIjSqQ" />
                                                    <div class="md:hidden bg-white dark:bg-background-dark p-4">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mt-1 font-sans text-sm">The grand opening of our first flagship store, Link landmark moment that brought our creations to the public.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="relative flex items-center group">
                                            <div class="hidden md:block w-1/2 pr-8">
                                                <div class="bg-white dark:bg-background-dark p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400 mt-2 font-sans">Our first international boutique opens in Paris, marking Link new chapter of global presence and recognition.</p>
                                                </div>
                                            </div>
                                            <div class="absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-primary ring-8 ring-background-light dark:ring-background-dark flex items-center justify-center">
                                            ...
                                            <div class="w-full md:w-1/2 md:pl-8">
                                                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <div class="md:hidden bg-white dark:bg-background-dark p-4">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mt-1 font-sans text-sm">Our first international boutique opens in Paris, marking Link new chapter of global presence and recognition.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="relative flex items-center flex-row-reverse group">
                                            <div class="hidden md:block w-1/2 pl-8">
                                                <div class="bg-white dark:bg-background-dark p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400 mt-2 font-sans">Introducing our commitment to ethically sourced materials and sustainable practices, ensuring beauty with Link conscience.</p>
                                                </div>
                                            </div>
                                            <div class="absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-primary ring-8 ring-background-light dark:ring-background-dark flex items-center justify-center">
                                            ...
                                            <div class="w-full md:w-1/2 md:pr-8">
                                                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <div class="md:hidden bg-white dark:bg-background-dark p-4">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mt-1 font-sans text-sm">Introducing our commitment to ethically sourced materials and sustainable practices, ensuring beauty with Link conscience.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="relative flex items-center group">
                                            <div class="hidden md:block w-1/2 pr-8">
                                                <div class="bg-white dark:bg-background-dark p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400 mt-2 font-sans">Continuing our tradition of excellence and looking towards Link bright future, innovating while honoring our heritage.</p>
                                                </div>
                                            </div>
                                            <div class="absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-primary ring-8 ring-background-light dark:ring-background-dark flex items-center justify-center">
                                            ...
                                            <div class="w-full md:w-1/2 md:pl-8">
                                                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                                                    ...
                                                    <div class="md:hidden bg-white dark:bg-background-dark p-4">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mt-1 font-sans text-sm">Continuing our tradition of excellence and looking towards Link bright future, innovating while honoring our heritage.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <footer class="flex flex-col gap-6 px-5 py-10 text-center border-t border-solid border-t-[#f0edea] dark:border-t-[#2a2622] mt-16">
                                <div class="flex flex-wrap items-center justify-center gap-6">
                                    <Link class="text-[#857360] dark:text-gray-400 text-base font-normal leading-normal min-w-40 font-sans" to="#">
                                        Terms of Service
                                    </Link>
                                    <Link class="text-[#857360] dark:text-gray-400 text-base font-normal leading-normal min-w-40 font-sans" to="#">
                                        Privacy Policy
